...
RUN ARCH=$(dpkg --print-architecture) && \
    if [ "$ARCH" = "amd64" ]; then \
        PANDOC_URL="https://github.com/jgm/pandoc/releases/download/3.8/pandoc-3.8.2.1-1-amd64.deb"; \
    elif [ "$ARCH" = "arm64" ]; then \
        PANDOC_URL="https://github.com/jgm/pandoc/releases/download/3.8/pandoc-3.8.2.1-1-arm64.deb"; \
    else \

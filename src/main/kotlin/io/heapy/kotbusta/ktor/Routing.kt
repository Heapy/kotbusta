...
import io.heapy.kotbusta.ktor.routes.books.getFeaturedBooksRoute
...
import io.heapy.kotbusta.ktor.routes.kindle.getKindleConfigRoute
...
import io.heapy.kotbusta.ktor.routes.kindle.uploadToKindleRoute
    ...
    routing {
        ...
        route("/api") {
            authenticate("auth-session") {
                ...
                getFeaturedBooksRoute()
                getBookCoverRoute()
                getBookContentRoute()
                getBookTocRoute()
                searchBookContentRoute()
                downloadBookRoute()
                getKindleConfigRoute()
                getDevicesRoute()
                createDeviceRoute()
                updateDeviceRoute()
                deleteDeviceRoute()
